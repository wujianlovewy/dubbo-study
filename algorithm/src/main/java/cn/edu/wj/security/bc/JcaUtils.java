 ...
 * @author jwu
 *
 * 参考：http://www.jb51.net/article/91620.htm java原生CA证书链生成
 * 	   http://openmind.iteye.com/blog/1691711
 */
public class JcaUtils {
    ...
    public static Certificate cert(String path) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
        ...
        X509Certificate rootCert = rootCredential.getCertificate();
        X509Certificate middleCert = interCredential.getCertificate();
        X509Certificate cert = endCredential.getCertificate();
    	...
    	System.out.println("verify certificate chain succeed...");
	}
